...
// Her adim_tur icin bobin bazinda istenecek TEK bir baslangic kalite olcumu.
// Bunlar ilk versiyon icin makul birer varsayim — sektorde yaygin kontrol
// noktalarindan secildi, gerektikce degistirilebilir/cogaltilabilir.
// key: kalite_verisi jsonb'inde saklanacak alan adi.
export const KALITE_ALANLARI: Record<string, { key: string; label: string; birim: string } | null> = {
  baski: { key: 'fotosel_cm', label: 'Fotosel olcusu', birim: 'cm' },
  laminasyon_1: { key: 'yapisma_n', label: 'Yapisma mukavemeti', birim: 'N/15mm' },
  laminasyon_2: { key: 'yapisma_n', label: 'Yapisma mukavemeti', birim: 'N/15mm' },
  laminasyon_3: { key: 'yapisma_n', label: 'Yapisma mukavemeti', birim: 'N/15mm' },
  kurleme_1: null, kurleme_2: null, kurleme_3: null, // bekleme adimi, operator girisi yok
  dilimleme: { key: 'kesim_tolerans_mm', label: 'Kesim genislik sapmasi', birim: 'mm' },
  katlama: { key: 'kat_hizalama_mm', label: 'Kat hizalama sapmasi', birim: 'mm' },
  yan_kesim: { key: 'kesim_genislik_mm', label: 'Kesim genisligi', birim: 'mm' },
  doypack: { key: 'kaynak_n', label: 'Kaynak mukavemeti', birim: 'N' },
  quadro: { key: 'kaynak_n', label: 'Kaynak mukavemeti', birim: 'N' },
  flat_bottom: { key: 'taban_kaynak_n', label: 'Taban kaynagi mukavemeti', birim: 'N' },
  sirt_kaynak: { key: 'kaynak_genislik_mm', label: 'Sirt kaynagi genisligi', birim: 'mm' },
  sonic: { key: 'kaynak_n', label: 'Sonic kaynak mukavemeti', birim: 'N' },
  diger: null,
}
