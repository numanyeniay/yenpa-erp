...
const ROL_LABEL: Record<string, string> = {
  admin: 'Admin', satis: 'Satis', planlama: 'Planlama', depo: 'Depo', uretim: 'Uretim', muhasebe: 'Muhasebe',
}
...
const NAV = [
  ...
  { href:'/bobin',       label:'Bobin Sorgula',         icon:'M7 7h.01M7 3h5.586a1 1 0 01.707.293l6.414 6.414a1 1 0 010 1.414l-8.586 8.586a1 1 0 01-1.414 0l-6.414-6.414A1 1 0 013 12.586V7a4 4 0 014-4z' },
  { href:'/is-durum',    label:'Is Durum Takibi',       icon:'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
    ...
    <aside className="w-56 min-h-screen bg-slate-900 flex flex-col flex-shrink-0">
      ...
      {user && (
        <div className="px-3 py-2.5 border-t border-white/10">
          <div className="text-xs text-white/80 font-medium truncate">{user.ad_soyad}</div>
          <div className="text-[10px] text-white/40">{ROL_LABEL[user.rol] || user.rol}</div>
        </div>
      )}
