...
const NAV = [
  ...
  { href:'/projeler',    label:'Projeler',           icon:'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
  { href:'/fiyatlama',   label:'Fiyatlama',          icon:'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
  ...
  { href:'/depo',        label:'Hammadde Deposu',    icon:'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
    ...
    <aside className="w-56 min-h-screen bg-slate-900 flex flex-col flex-shrink-0">
      <div className="p-4 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-white font-semibold text-sm">Yenpa ERP</div>
            <div className="text-white/40 text-xs">v2.0</div>
          </div>
        </div>
      </div>
